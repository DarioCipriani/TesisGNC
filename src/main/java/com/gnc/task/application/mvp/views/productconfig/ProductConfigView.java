package com.gnc.task.application.mvp.views.productconfig;
...
import com.gnc.task.application.mvp.presenter.ProductService;
            ...
            if (GUARDAR.equals(saveButton.getText())) {
                ...
                if (NEW_PRODUCTO.equals(saveButton.getText())) {
                    ...
                    ViewUtils.notification("Algo esta mal",
                            ...
                            NotificationVariant.LUMO_ERROR, Notification.Position.MIDDLE,5).open();
            }
