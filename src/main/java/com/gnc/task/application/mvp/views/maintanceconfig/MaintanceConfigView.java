package com.gnc.task.application.mvp.views.maintanceconfig;

import com.gnc.task.application.mvp.model.entity.Role;
import com.gnc.task.application.mvp.model.entity.TMantenimiento;
...
import com.gnc.task.application.mvp.presenter.MaintanceService;
                        ...
                        confirmEvent -> {
                            if (Objects.nonNull(mantenimiento) && maintanceService.deleteMantenimientoByMantenimientoID(mantenimiento.getId())) {
                                ViewUtils.notification("Borrado exitoso", "<b>Mantenimiento:</b> " + detalle + "</br>",
                                        NotificationVariant.LUMO_SUCCESS, Notification.Position.MIDDLE,15).open();
                                refreshGrid();
                                saveButton.setText(NEW_MANTENIMIENTO);
